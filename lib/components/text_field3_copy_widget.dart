...
import 'text_field3_copy_model.dart';
export 'text_field3_copy_model.dart';

class TextField3CopyWidget extends StatefulWidget {
  const TextField3CopyWidget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
  ...
  @override
  State<TextField3CopyWidget> createState() => _TextField3CopyWidgetState();
}

class _TextField3CopyWidgetState extends State<TextField3CopyWidget> {
  late TextField3CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField3CopyModel());
